<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="MainPage.aspx.cs" Inherits="MainPage" %>
            ...
            <table class="auto-style4">
                <tr>
                    <td class="auto-style5"><strong>
                       ...
                       <a href="RecipeDetails.aspx?RecipeId=<%# Eval("RecipeId")%>"> <asp:Label ID="Label3" runat="server" Text='<%# Eval("RecipeName") %>'></asp:Label></a>
